...
mipsel-openwrt-linux-gcc yublackmac.c -L./ -I./json/out/include/json/  -L./json/out/lib -ljson -luci -lubox -lpthread -o yublackmac
...
bool load_config()
{
    ...
    char *value,*ip;
    char blacklist[245];
    char blacklist_temp[245];
    char *shijian,*riqi,*mac;
    int  first = 0 ;
    int  i;
